...
using Soenneker.Composio.OpenApiClient.Api.V31.Tools.Execute.Item.Input;
...
{
    /// <summary>
    /// Builds and executes requests for operations under \api\v3.1\tools\execute\{tool_slug}
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class WithTool_slugItemRequestBuilder : BaseRequestBuilder
    {
        /// <summary>The input property</summary>
        public global::Soenneker.Composio.OpenApiClient.Api.V31.Tools.Execute.Item.Input.InputRequestBuilder Input
        {
            get => new global::Soenneker.Composio.OpenApiClient.Api.V31.Tools.Execute.Item.Input.InputRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Composio.OpenApiClient.Api.V31.Tools.Execute.Item.WithTool_slugItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithTool_slugItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v3.1/tools/execute/{tool_slug}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Composio.OpenApiClient.Api.V31.Tools.Execute.Item.WithTool_slugItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithTool_slugItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v3.1/tools/execute/{tool_slug}", rawUrl)
        {
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Composio.OpenApiClient.Api.V31.Tools.Execute.Item.WithTool_slugPostResponse"/></returns>
...
#nullable restore
        ...
        public async Task<global::Soenneker.Composio.OpenApiClient.Api.V31.Tools.Execute.Item.WithTool_slugPostResponse> PostAsync(global::Soenneker.Composio.OpenApiClient.Api.V31.Tools.Execute.Item.WithTool_slugPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Composio.OpenApiClient.Api.V31.Tools.Execute.Item.WithTool_slugPostResponse>(requestInfo, global::Soenneker.Composio.OpenApiClient.Api.V31.Tools.Execute.Item.WithTool_slugPostResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Execute a specific tool operation with provided arguments and authentication. This is the primary endpoint for integrating with third-party services and executing tools. You can provide structured arguments or use natural language processing by providing a text description of what you want to accomplish.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Composio.OpenApiClient.Api.V31.Tools.Execute.Item.WithTool_slugPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Composio.OpenApiClient.Api.V31.Tools.Execute.Item.WithTool_slugPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Composio.OpenApiClient.Api.V31.Tools.Execute.Item.WithTool_slugItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Composio.OpenApiClient.Api.V31.Tools.Execute.Item.WithTool_slugItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}

...
namespace Soenneker.Composio.OpenApiClient.Api.V3.Files.Upload.Request
{
    ...
    public partial class RequestRequestBuilder : BaseRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Composio.OpenApiClient.Models.PostFilesUploadRequest200Response"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Composio.OpenApiClient.Models.PostFilesUploadRequest200Response?> PostAsync(global::Soenneker.Composio.OpenApiClient.Models.PostFilesUploadRequestRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Composio.OpenApiClient.Models.PostFilesUploadRequest200Response> PostAsync(global::Soenneker.Composio.OpenApiClient.Models.PostFilesUploadRequestRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Composio.OpenApiClient.Models.PostFilesUploadRequest200Response>(requestInfo, global::Soenneker.Composio.OpenApiClient.Models.PostFilesUploadRequest200Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Generates a presigned URL for uploading a file to S3. This endpoint handles deduplication by checking if a file with the same MD5 hash already exists.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Composio.OpenApiClient.Models.PostFilesUploadRequestRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Composio.OpenApiClient.Models.PostFilesUploadRequestRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)

...
using System;
namespace Soenneker.Composio.OpenApiClient.Api.V3.Org
{
    /// <summary>
    /// Builds and executes requests for operations under \api\v3\org
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class OrgRequestBuilder : BaseRequestBuilder
    {
        /// <summary>The consumer property</summary>
        public global::Soenneker.Composio.OpenApiClient.Api.V3.Org.Consumer.ConsumerRequestBuilder Consumer
        {
        ...
        public OrgRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v3/org", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Composio.OpenApiClient.Api.V3.Org.OrgRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public OrgRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v3/org", rawUrl)
        {
        }
    }
}

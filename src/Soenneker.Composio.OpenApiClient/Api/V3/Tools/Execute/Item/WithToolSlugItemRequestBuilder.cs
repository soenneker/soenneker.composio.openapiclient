...
{
    /// <summary>
    /// Builds and executes requests for operations under \api\v3\tools\execute\{toolSlug}
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class WithToolSlugItemRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Composio.OpenApiClient.Api.V3.Tools.Execute.Item.WithToolSlugItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithToolSlugItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v3/tools/execute/{toolSlug}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Composio.OpenApiClient.Api.V3.Tools.Execute.Item.WithToolSlugItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithToolSlugItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v3/tools/execute/{toolSlug}", rawUrl)
        {
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Composio.OpenApiClient.Models.PostToolsExecuteByToolSlug200Response"/></returns>
        ...
        /// <exception cref="global::Soenneker.Composio.OpenApiClient.Models.Error">When receiving a 402 status code</exception>
...
#nullable enable
        public async Task<global::Soenneker.Composio.OpenApiClient.Models.PostToolsExecuteByToolSlug200Response?> PostAsync(global::Soenneker.Composio.OpenApiClient.Models.PostToolsExecuteByToolSlugRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Composio.OpenApiClient.Models.PostToolsExecuteByToolSlug200Response> PostAsync(global::Soenneker.Composio.OpenApiClient.Models.PostToolsExecuteByToolSlugRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>>
            {
                ...
                { "402", global::Soenneker.Composio.OpenApiClient.Models.Error.CreateFromDiscriminatorValue },
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Composio.OpenApiClient.Models.PostToolsExecuteByToolSlug200Response>(requestInfo, global::Soenneker.Composio.OpenApiClient.Models.PostToolsExecuteByToolSlug200Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Execute a specific tool operation with provided arguments and authentication. This is the primary endpoint for integrating with third-party services and executing tools. You can provide structured arguments or use natural language processing by providing a text description of what you want to accomplish.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Composio.OpenApiClient.Models.PostToolsExecuteByToolSlugRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Composio.OpenApiClient.Models.PostToolsExecuteByToolSlugRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Composio.OpenApiClient.Api.V3.Tools.Execute.Item.WithToolSlugItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Composio.OpenApiClient.Api.V3.Tools.Execute.Item.WithToolSlugItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}

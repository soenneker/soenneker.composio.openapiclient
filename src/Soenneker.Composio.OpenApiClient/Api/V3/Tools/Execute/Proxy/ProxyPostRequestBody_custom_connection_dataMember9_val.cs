...
namespace Soenneker.Composio.OpenApiClient.Api.V3.Tools.Execute.Proxy
{
    ...
    public partial class ProxyPostRequestBody_custom_connection_dataMember9_val : IAdditionalDataHolder, IParsable
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Composio.OpenApiClient.Api.V3.Tools.Execute.Proxy.ProxyPostRequestBody_custom_connection_dataMember9_val"/> and sets the default values.
        /// </summary>
        public ProxyPostRequestBody_custom_connection_dataMember9_val()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Composio.OpenApiClient.Api.V3.Tools.Execute.Proxy.ProxyPostRequestBody_custom_connection_dataMember9_val"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Composio.OpenApiClient.Api.V3.Tools.Execute.Proxy.ProxyPostRequestBody_custom_connection_dataMember9_val CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Composio.OpenApiClient.Api.V3.Tools.Execute.Proxy.ProxyPostRequestBody_custom_connection_dataMember9_val();
        }
        /// <summary>

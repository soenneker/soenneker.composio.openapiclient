...
namespace Soenneker.Composio.OpenApiClient.Api.V3.Trigger_instances.Item.Upsert
{
    ...
    public partial class UpsertRequestBuilder : BaseRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Composio.OpenApiClient.Models.PostTriggerInstancesBySlugUpsert200"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Composio.OpenApiClient.Models.PostTriggerInstancesBySlugUpsert200?> PostAsync(global::Soenneker.Composio.OpenApiClient.Models.PostTriggerInstancesBySlugUpsert body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Composio.OpenApiClient.Models.PostTriggerInstancesBySlugUpsert200> PostAsync(global::Soenneker.Composio.OpenApiClient.Models.PostTriggerInstancesBySlugUpsert body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Composio.OpenApiClient.Models.PostTriggerInstancesBySlugUpsert200>(requestInfo, global::Soenneker.Composio.OpenApiClient.Models.PostTriggerInstancesBySlugUpsert200.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Creates a new trigger instance or updates an existing one with the same configuration. Triggers listen for events from external services (webhooks or polling) and can invoke your workflows. If a matching trigger already exists and is disabled, it will be re-enabled. Requires a connected account ID to associate the trigger with a specific user connection.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Composio.OpenApiClient.Models.PostTriggerInstancesBySlugUpsert body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Composio.OpenApiClient.Models.PostTriggerInstancesBySlugUpsert body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)

...
{
    /// <summary>
    /// Builds and executes requests for operations under \api\v3\tool_router\session\{session_id}\proxy_execute
    /// </summary>
    ...
    public partial class Proxy_executeRequestBuilder : BaseRequestBuilder
    {
        ...
        public Proxy_executeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v3/tool_router/session/{session_id}/proxy_execute", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Composio.OpenApiClient.Api.V3.Tool_router.Session.Item.Proxy_execute.Proxy_executeRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Proxy_executeRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v3/tool_router/session/{session_id}/proxy_execute", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        public async Task<global::Soenneker.Composio.OpenApiClient.Api.V3.Tool_router.Session.Item.Proxy_execute.Proxy_executePostResponse> PostAsync(global::Soenneker.Composio.OpenApiClient.Api.V3.Tool_router.Session.Item.Proxy_execute.Proxy_executePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Composio.OpenApiClient.Api.V3.Tool_router.Session.Item.Proxy_execute.Proxy_executePostResponse>(requestInfo, global::Soenneker.Composio.OpenApiClient.Api.V3.Tool_router.Session.Item.Proxy_execute.Proxy_executePostResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Execute any native API call on a toolkit with authentication automatically injected from Composio. This endpoint proxies HTTP requests to third-party APIs using connected account credentials resolved from the session context. Provide the toolkit slug, API endpoint, and HTTP method — Composio handles authentication injection, abstracting away credential management. Supports all HTTP methods, custom headers/query parameters, and binary request/response bodies.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Composio.OpenApiClient.Api.V3.Tool_router.Session.Item.Proxy_execute.Proxy_executePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Composio.OpenApiClient.Api.V3.Tool_router.Session.Item.Proxy_execute.Proxy_executePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
